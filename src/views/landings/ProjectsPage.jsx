...
export default function ProjectsPage() {
  ...
  const coverImg = isDarkMode
    ? '/assets/images/LandingPageImages/Projects-Dark.png'
    : '/assets/images/LandingPageImages/Projects-Light.png';
  ...
  return (
    <Box sx={{ bgcolor: 'background.default', minHeight: '100vh', pb: 6 }}>
      ...
      >
        ...
        />
        {/* Overlay for text visibility, same as DashboardPage */}
        <Box sx={{
          position: 'absolute',
          top: 0,
          left: 0,
          ...
          <Box sx={{ textAlign: 'center', px: 2 }}>
            ...
            >
              Set, track, and achieve your goals with our intuitive Projects page. Visualize progress, break down objectives, and celebrate milestones.
            </Typography>
          </Box>
        </Box>
      </Box>
          ...
          <CardContent sx={{ p: 4 }}>
            ...
            <Box component="ul" sx={{ pl: 2, color: 'text.secondary' }}>
              <Typography component="li" variant="body1" sx={{ mb: 1.5, lineHeight: 1.6 }}>
                Break projects into milestones for better tracking.
              </Typography>
              <Typography component="li" variant="body1" sx={{ mb: 1.5, lineHeight: 1.6 }}>
                Set reminders for deadlines and important meetings.
              </Typography>
              <Typography component="li" variant="body1" sx={{ mb: 1.5, lineHeight: 1.6 }}>
                Collaborate with your team for faster progress.
              </Typography>
