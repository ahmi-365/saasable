...
export const ADMIN_PATH = 'https://free.admin.Planify.io/';
export const BUY_NOW_URL = 'https://mui.com/store/items/Planify-multipurpose-ui-kit-and-dashboard-template';
export const FREEBIES_URL = 'https://github.com/phoenixcoded/Planify-ui';
export const DOCS_URL = 'https://phoenixcoded.gitbook.io/Planify ';
